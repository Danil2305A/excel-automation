...
ldd --version
```
Если в системе версия glibс < 2.34, программа не сможет запуститься. В таком случае нужно менять в [cd.yaml](.github/workflows/cd.yaml) задачу build-redos, например, обновить версию образа almalinux на более новую.
